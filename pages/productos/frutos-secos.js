...
class FrutosSecos extends React.Component {
  constructor(props) {
    super(props);
    this.myVar = "";
    this.myFunction = () => {
    ...
    return (
      <>
        <Head>
          ...
          <meta
            name="description"
            content="Disponemos de variedad en legumbres , escoge la cantidad deseada , a partir de un kilo."
          ></meta>
        </Head>
        ...
        <div className="metaDiv">
          <div>
            <h1>Frutos secos</h1>
            <p>
            Disponemos de variedad en frutos secos , escoge la cantidad deseada , a partir de un kilo.
            </p>
            <p>

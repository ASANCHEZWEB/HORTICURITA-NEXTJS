...
class Encurtidos extends React.Component {
  constructor(props) {
    super(props);
    this.myVar = "";
    this.myFunction = () => {
...
componentWillUnmount(){
  ...
  render() {
    return (
      <>
        <Head>
          <title>🍢Encurtidos🍢</title>
          <meta
            name="description"
            content="Prueba un solo bocado de estos encurtidos y te aseguramos que repetirás!😉"
          ></meta>
        </Head>

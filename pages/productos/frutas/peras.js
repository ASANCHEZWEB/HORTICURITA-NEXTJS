...
class Peras extends React.Component {
  constructor(props) {
    super(props);
    this.myVar = "";
    this.myFunction = () => {
    ...
    return (
      <>
        <Head>
          ...
          <meta
            name="description"
            content="Deliciosas peras a tan solo un click! . ¡Añade al carrito la cantidad deseada!🤪"
          ></meta>
        </Head>
        ...
        <div className="metaDiv">
          <div>
            <h1>🍌Plátanos🍌</h1>
            <p>
            Deliciosas peras a tan solo un click! . ¡Añade al carrito la cantidad deseada!🤪
            </p>
            <p>

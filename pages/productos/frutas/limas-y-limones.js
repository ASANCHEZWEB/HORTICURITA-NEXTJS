...
class LimonesyLimones extends React.Component {
  constructor(props) {
    super(props);
    this.myVar = "";
    this.myFunction = () => {
...
componentWillUnmount(){
  ...
  render() {
    return (
      <>
        <Head>
          <title>🍋Limas y Limones🍋</title>
          <meta
            name="description"
            content="Agrega un toque de sabor a tus comidas , prepárate un rico zumo o utilízalo en cócteles!🍸"
          ></meta>
        </Head>

        <div className="metaDiv">
          <div>
            <h1>🍋Limas y Limones🍋</h1>
            <p>
            Agrega un toque de sabor a tus comidas , prepárate un rico zumo o utilízalo en cócteles!🍸
            </p>
            <p>
...
export async function getStaticProps() {
  ...
  let dataMapped = () => {
    return [...data.productos]
      .map((product) => {
        if (product.subcategory === "limas-y-limones") {
          return {
            _id: product._id,
            name: product.name,
            price: product.price,
...
export default LimonesyLimones;

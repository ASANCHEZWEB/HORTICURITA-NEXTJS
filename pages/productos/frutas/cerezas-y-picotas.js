...
class CerezasYPicotas extends React.Component {
  constructor(props) {
    super(props);
    this.myVar = "";
    this.myFunction = () => {
...
componentWillUnmount(){
  ...
  render() {
    return (
      <>
        <Head>
          <title>🍒Cerezas y picotas🍒</title>
          <meta
            name="description"
            content="Disfruta en esta temporada de las cerezas mas sabrosas y dulces ."
          ></meta>
        </Head>

        <div className="metaDiv">
          <div>
            <h1>🍒Cerezas y picotas🍒</h1>
            <p>
            Disfruta en esta temporada de las cerezas mas sabrosas y dulces .
            </p>
            <p>
...
export async function getStaticProps() {
  ...
  let dataMapped = () => {
    return [...data.productos]
      .map((product) => {
        if (product.subcategory === "cerezas-y-picotas") {
          return {
            _id: product._id,
            name: product.name,
            price: product.price,
...
export default CerezasYPicotas;

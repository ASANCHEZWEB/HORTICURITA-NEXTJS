...
class Kiwis extends React.Component {
  constructor(props) {
    super(props);
    this.myVar = "";
    this.myFunction = () => {
    ...
    return (
      <>
        <Head>
          ...
          <meta
            name="description"
            content="Ya sea que necesites mejorar tu digestión o necesites adelgazar , ¡añade estos kiwis al carrito!"
          ></meta>
        </Head>
        ...
        <div className="metaDiv">
          <div>
            <h1>🥝Kiwis🥝</h1>
            <p>
            Ya sea que necesites mejorar tu digestión o necesites adelgazar , ¡añade estos kiwis al carrito!
            </p>
            <p>

...
class FrutasBosque extends React.Component {
  constructor(props) {
    super(props);
    this.myVar = "";
    this.myFunction = () => {
...
componentWillUnmount(){
  ...
  render() {
    return (
      <>
        <Head>
          <title>Frutas del bosque</title>
          <meta
            name="description"
            content="¡Frutas antioxidantes con variedad para elegir!"
          ></meta>
        </Head>

        <div className="metaDiv">
          <div>
            <h1>Frutas del bosque</h1>
            <p>
            ¡Frutas antioxidantes con variedad para elegir!
            </p>
            <p>
...
export async function getStaticProps() {
  ...
  let dataMapped = () => {
    return [...data.productos]
      .map((product) => {
        if (product.subcategory === "frutas-del-bosque") {
          return {
            _id: product._id,
            name: product.name,
            price: product.price,

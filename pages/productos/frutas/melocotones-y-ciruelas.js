...
class MelocotonesYCiruelas extends React.Component {
  constructor(props) {
    super(props);
    this.myVar = "";
    this.myFunction = () => {
...
componentWillUnmount(){
  ...
  render() {
    return (
      <>
        <Head>
          <title>🍑Melocotones y Ciruelas🍑</title>
          <meta
            name="description"
            content="Deliciosas ciruelas y melocotones a golpe de click!. Escoge la cantidad deseada y disfruta😉."
          ></meta>
        </Head>

        <div className="metaDiv">
          <div>
            <h1>🍑Melocotones y Ciruelas🍑</h1>
            <p>
            Deliciosas ciruelas y melocotones a golpe de click!. Escoge la cantidad deseada y disfruta😉.
            </p>
            <p>
...
export async function getStaticProps() {
  ...
  let dataMapped = () => {
    return [...data.productos]
      .map((product) => {
        if (product.subcategory === "melocotones-y-ciruelas") {
          return {
            _id: product._id,
            name: product.name,
            price: product.price,
...
export default MelocotonesYCiruelas;

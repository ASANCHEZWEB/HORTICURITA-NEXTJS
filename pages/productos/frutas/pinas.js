...
class Piñas extends React.Component {
  constructor(props) {
    super(props);
    this.myVar = "";
    this.myFunction = () => {
    ...
    return (
      <>
        <Head>
          ...
          <meta
            name="description"
            content=" ¿A quién no le apetece piña fresca y dulce repleta de vitaminas?. ¡Añade a tu carrito estas deliciosas piñas! 😋 ."
          ></meta>
        </Head>
        ...
        <div className="metaDiv">
          <div>
            <h1>🍍Piñas🍍</h1>
            <p>
            ¿A quién no le apetece piña fresca y dulce repleta de vitaminas?. ¡Añade a tu carrito estas deliciosas piñas! 😋 .
            </p>
            <p>

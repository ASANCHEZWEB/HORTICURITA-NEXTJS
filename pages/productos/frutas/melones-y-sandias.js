...
class MelonesYSandias extends React.Component {
  constructor(props) {
    super(props);
    this.myVar = "";
    this.myFunction = () => {
...
componentWillUnmount(){
  ...
  render() {
    return (
      <>
        <Head>
          <title>🍉Melones y sandías🍉</title>
          <meta
            name="description"
            content="En estos días calurosos de verano ¿a quién no le apetece un dulce melón o sandía? .¡Perfecto para refrescarte o hacerte un rico zumo🍹!"
          ></meta>
        </Head>

        <div className="metaDiv">
          <div>
            <h1>🍉Melones y sandías🍉</h1>
            <p>
            En estos días calurosos de verano ¿a quién no le apetece un dulce melón o sandía? .¡Perfecto para refrescarte o hacerte un rico zumo🍹!
            </p>
            <p>
...
export async function getStaticProps() {
  ...
  let dataMapped = () => {
    return [...data.productos]
      .map((product) => {
        if (product.subcategory === "melones-y-sandias") {
          return {
            _id: product._id,
            name: product.name,
            price: product.price,
            ...
            subcategoryPos: product.subcategoryPos,
...
export default MelonesYSandias;

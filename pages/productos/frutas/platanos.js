...
class Platanos extends React.Component {
  constructor(props) {
    super(props);
    this.myVar = "";
    this.myFunction = () => {
...
componentWillUnmount(){
  ...
  render() {
    return (
      <>
        <Head>
          <title>🍌Plátanos🍌</title>
          <meta
            name="description"
            content="¿Te apetece un chute de vitaminas? .¡Añade a tu carrito estos deliciosos plátanos!."
          ></meta>
        </Head>
        ...
        <div className="metaDiv">
          <div>
            <h1>🍌Plátanos🍌</h1>
            <p>
            ¿Te apetece un chute de vitaminas? .¡Añade a tu carrito estos deliciosos plátanos!.
            </p>
            <p>
...
export async function getStaticProps() {
  ...
  let dataMapped = () => {
    return [...data.productos]
      .map((product) => {
        if (product.subcategory === "platanos") {
          return {
            _id: product._id,
            name: product.name,
            price: product.price,

...
class Naranjas extends React.Component {
  constructor(props) {
    super(props);
    this.myVar = "";
    this.myFunction = () => {
    ...
    return (
      <>
        <Head>
          ...
          <meta
            name="description"
            content="Recibe un chute de vitamina C con estas deliciosas naranjas , ¡refuerza tu sistema inmunológico!🤧"
          ></meta>
        </Head>
        ...
        <div className="metaDiv">
          <div>
            <h1>🍊Naranjas🍊</h1>
            <p>
            Recibe un chute de vitamina C con estas deliciosas naranjas , ¡refuerza tu sistema inmunológico!🤧
            </p>
            <p>
...
export async function getStaticProps() {
  ...
  let dataMapped = () => {
    return [...data.productos]
      .map((product) => {
        if (product.subcategory === "naranjas") {
          return {
            _id: product._id,
            name: product.name,
            price: product.price,

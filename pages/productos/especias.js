...
class Especias extends React.Component {
  constructor(props) {
    super(props);
    this.myVar = "";
    this.myFunction = () => {
    ...
    return (
      <>
        <Head>
          ...
          <meta
            name="description"
            content="Condimenta tus recetas con estas especias y dale un toque de sabor"
          ></meta>
        </Head>
        ...
        <div className="metaDiv">
          <div>
            <h1>🧂Especias🧂</h1>
            <p>
            Condimenta tus recetas con estas especias y dale un toque de sabor
            </p>
            <p>

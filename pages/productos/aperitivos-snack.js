...
class AperitivosSnack extends React.Component {
  constructor(props) {
    super(props);
    this.myVar = "";
    this.myFunction = () => {
...
componentWillUnmount(){
  ...
  render() {
    return (
      <>
        <Head>
          <title>🥨Aperitivos Snack🥨</title>
          <meta
            name="description"
            content="Ademas de la gran variedad de productos que tenemos , también tenemos snacks! Añadelos a tu carrito"
          ></meta>
        </Head>
...
export default AperitivosSnack;

...
class GalletasYcereales extends React.Component {
  constructor(props) {
    super(props);
    this.state = {};
  }
          ...
          <div>
            ...
            <p>
              *Damos especial atención a la calidad de nuestros productos,por lo
              tanto, si los productos recibidos están dañados,
          ...
          {this.props.data.map((product, index) => {
            if (product.name) {
              return (
                <div key={product._id}>
                  <Link
                    href="/productos/galletas-y-cereales/[id]"
                    as={`/productos/galletas-y-cereales/${product.urlRoute}`}
                  >
...
export default GalletasYcereales;

...
class Pimientos extends React.Component {
  constructor(props) {
    super(props);
    this.myVar = "";
    this.myFunction = () => {
    ...
    return (
      <>
        <Head>
          ...
          <meta
            name="description"
            content="Para tus mejores guisos no pueden faltar unos pimientos que den el toque.🥘"
          ></meta>
        </Head>
        ...
        <div className="metaDiv">
          <div>
            <h1>Pimientos</h1>
            <p>
            Para tus mejores guisos no pueden faltar unos pimientos que den el toque.🥘
            </p>
            <p>
...
export async function getStaticProps() {
  ...
  let dataMapped = () => {
    return [...data.productos]
      .map((product) => {
        if (product.subcategory === "pimientos") {
          return {
            _id: product._id,
            name: product.name,
            price: product.price,

...
class DeTierra extends React.Component {
  constructor(props) {
    super(props);
    this.myVar = "";
    this.myFunction = () => {
    ...
    return (
      <>
        <Head>
          ...
          <meta
            name="description"
            content="Además de la gran variedad de productos de nuestro menú , aquí podrás encontrar variedad de productos de terreno."
          ></meta>
        </Head>
        ...
        <div className="metaDiv">
          <div>
            <h1>De tierra</h1>
            <p>
            Además de la gran variedad de productos de nuestro menú , aquí podrás encontrar variedad de productos de terreno.
            </p>
            <p>
...
export async function getStaticProps() {
  ...
  let dataMapped = () => {
    return [...data.productos]
      .map((product) => {
        if (product.subcategory === "de-tierra") {
          return {
            _id: product._id,
            name: product.name,
            price: product.price,

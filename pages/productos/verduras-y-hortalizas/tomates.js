...
class Tomates extends React.Component {
  constructor(props) {
    super(props);
    this.myVar = "";
    this.myFunction = () => {
    ...
    return (
      <>
        <Head>
          ...
          <meta
            name="description"
            content="El producto estrella de esta temporada , perfecto para ensaladas y comidas!"
          ></meta>
        </Head>
        ...
        <div className="metaDiv">
          <div>
            <h1>🍅Tomates🍅</h1>
            <p>
            El producto estrella de esta temporada , perfecto para ensaladas y comidas!
            </p>
            <p>
...
export async function getStaticProps() {
  ...
  let dataMapped = () => {
    return [...data.productos]
      .map((product) => {
        if (product.subcategory === "tomates") {
          return {
            _id: product._id,
            name: product.name,
            price: product.price,

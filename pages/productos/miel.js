...
class Mieles extends React.Component {
  constructor(props) {
    super(props);
    this.myVar = "";
    this.myFunction = () => {
    ...
    return (
      <>
        <Head>
          ...
          <meta
            name="description"
            content="Colaboramos con productores de miel locales para ofrecerte miel de calidad a un precio justo 😉 "
          ></meta>
        </Head>
        ...
        <div className="metaDiv">
          <div>
            <h1>🍯Miel🍯</h1>
            <p>
            Colaboramos con productores de miel locales para ofrecerte miel de calidad a un precio justo 😉 
            </p>
            <p>

...
function showList(){
  ...
  if (
    ...
    document.querySelector("nav>div:nth-child(2)>button>img").setAttribute("src", "https://res.cloudinary.com/dfsni6m2x/image/upload/v1593638701/iconosHorticurita/closeMenu_ovofxv.png");
  } else {
    document.querySelector("nav>div:nth-child(2)>button>img").setAttribute("src", "https://res.cloudinary.com/dfsni6m2x/image/upload/v1593638715/iconosHorticurita/menu_y9uxib.svg");
  }
};
